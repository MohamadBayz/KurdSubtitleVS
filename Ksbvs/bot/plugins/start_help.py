# (c) Ksbvs-goel 
from Ksbvs.bot import StreamBot
from Ksbvs.vars import Var
import logging
logger = logging.getLogger(__name__)
from Ksbvs.bot.plugins.stream import MY_PASS
from Ksbvs.utils.human_readable import humanbytes
from Ksbvs.utils.database import Database
from pyrogram import filters
from pyrogram.types import InlineKeyboardMarkup, InlineKeyboardButton
from pyrogram.errors import UserNotParticipant
from Ksbvs.utils.file_properties import get_name, get_hash, get_media_file_size
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [Ksbvs GOEL](https://t.me/agprojectschat).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("💥 FOLLOW", url="https://GitHub.com/Ksbvs-goel")]
            ]
        )
    )
